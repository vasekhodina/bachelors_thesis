...
\subsection{GParted}
 ...
 se zprvu rozhodli použít známé schéma, avšak brzy narazili na problém s~větším počtem zařízení včetně virtuálních. Na obrázku č.~6 vidíme, že současné řešení je nedostatečné, jednotlivé úrovně 
 barevných rámců 
...
\section{Knihovna Blivet}
	...
	ve firmě Red Hat, původně pod jménem pyanaconda.storage\cite{blivet-wiki}. Slouží k~rozšíření již zmiňovaného instalátoru Anaconda. Použití této knihovny je součástí zadání, 
...
\subsection{Graf}
	...
	hrany vedoucí od uzlu k~podgrafu (texttt{A~-- \{B C\}}) vytvoříme stejný efekt jako při zápisu každé jednotlivé dvojice mezi uzlem A~a~uzly B a~C (texttt{A~-- B, A~-- C}). Dále je možné podgrafy využít
