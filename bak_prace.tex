...
\chapter{Závěr}
  Hlavním cílem mé práce byla vizualizace dat z~Blivetu do samostatného okna GTK aplikace a~zobrazení připravených změn. Dalším cílem příprava funkcí pro snadnou integraci
	do dalších programů.   
